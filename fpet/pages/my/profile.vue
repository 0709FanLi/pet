    ...
    <view class="profile-header bg-gradient-primary">
      <view class="profile-header__content">
        <view class="profile-avatar-container">
          <view v-if="!user.avatar" class="profile-avatar profile-avatar--default">
        ...
        <view class="profile-info">
          <text class="profile-name">{{ isLoggedIn ? (user.username || '爱宠主人') : '未登录' }}</text>
          <text class="profile-phone">{{ isLoggedIn ? (user.phoneNumber || '未绑定手机号') : '点击登录查看更多功能' }}</text>
    ...
    <view class="page-content">
      ...
      <view v-if="isLoggedIn" class="quick-actions">
        ...
        <view class="quick-action" @click="handleDetectiveAction">
          ...
          <view v-if="detectiveStatus === 'pending'" class="quick-action__badge">
            <text class="badge badge--warning">审核中</text>
          </view>
          <view v-else-if="detectiveStatus === 'approved'" class="quick-action__badge">
      ...
      <view v-else class="login-prompt">
        <view class="login-prompt__content">
          ...
          <text class="login-prompt__desc">发布寻宠信息、申请成为宠物侦探等</text>
        </view>
      </view>
      ...
      <view class="auth-section">
        <view v-if="!isLoggedIn" class="btn btn--primary btn--block" @click="goLogin">
